(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@tippyjs/react'), require('react/jsx-runtime'), require('clsx'), require('prop-types'), require('@mui/material/styles'), require('@mui/system'), require('@mui/material/Icon'), require('lodash'), require('@mui/material'), require('zustand'), require('immer'), require('nanoevents'), require('react-use'), require('@mui/material/Menu'), require('@mui/icons-material')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@tippyjs/react', 'react/jsx-runtime', 'clsx', 'prop-types', '@mui/material/styles', '@mui/system', '@mui/material/Icon', 'lodash', '@mui/material', 'zustand', 'immer', 'nanoevents', 'react-use', '@mui/material/Menu', '@mui/icons-material'], factory) :
  (global = global || self, factory(global.fuseBase = {}, global.react, global.Tippy, global.jsxRuntime, global.clsx, global.propTypes, global.styles, global.system, global.Icon, global.lodash, global.material, global.zustand, global.immer, global.nanoevents, global.reactUse, global.Menu, global.iconsMaterial));
})(this, (function (exports, React, Tippy, jsxRuntime, clsx, PropTypes, styles, system, Icon, lodash, material, create, produce, nanoevents, reactUse, Menu, iconsMaterial) {
