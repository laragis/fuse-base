...
import React__default, { memo, forwardRef, useRef, useImperativeHandle, useState, useMemo, useCallback, useEffect, isValidElement } from 'react';
...
import { includes, replace, some, isEmpty, isBoolean, pick, reject, isArray, map } from 'lodash';
import { Box as Box$1, MenuItem as MenuItem$2, ListItemIcon, ListItemText, Divider, Menu as Menu$1, IconButton as IconButton$2, Stack, styled as styled$1, LinearProgress, Typography } from '@mui/material';
...
var _excluded$5 = ["parentMenuOpen", "label", "rightIcon", "leftIcon", "children", "className", "tabIndex", "ContainerProps"],
  _excluded2$2 = ["ref"];
var SubMenuItem = /*#__PURE__*/React__default.forwardRef(function SubMenu(props, ref) {
...
function ContextMenu(_ref) {
  ...
  return /*#__PURE__*/jsxs("div", {
    ...
    children: [!isEmpty(items) && /*#__PURE__*/jsx(Menu$1, {
      open: open,
      onClose: handleClose,
...
function ToolbarItem(props) {
  ...
  var content = shownContent && /*#__PURE__*/jsx(IconButton$2, {
    size: btnSize,
    onClick: handleClick,
    color: color,
...
var IconButton = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var items = useMemo(function () {
    return reject(inItems, function (i) {
  ...
  return shownContent && /*#__PURE__*/jsxs(Fragment, {
    children: [/*#__PURE__*/jsx(Tooltip$1, {
      title: tooltip,
      children: /*#__PURE__*/jsx(IconButton$2, {
        onClick: handleClick,
        color: color,
        type: type,
        ref: ref,
        children: children ? children : /*#__PURE__*/jsx(MySvgIcon, _extends({}, iconProps, {
          children: icon
        }))
      })
    }), shownContent && !isEmpty(items) && /*#__PURE__*/jsx(ButtonMenu, {
      items: items,
      anchorEl: anchorEl,
...
IconButton.propTypes = {
  ...
  fontSize: PropTypes__default.number,
...
function PageSide(props) {
  ...
  return /*#__PURE__*/jsxs(Root, {
    className: clsx('PageSide-root', "PageSide-scroll-" + props.scroll, props.className)
    // ref={rootRef}
    ,
    scroll: props.scroll,
    ...
    children: [/*#__PURE__*/jsxs("div", {
      ...
      children: [props.leftSidebarContent && /*#__PURE__*/jsx("div", {
        ...
        children: [props.header && (isBoolean(props.header) ? /*#__PURE__*/jsx(Component, _extends({
          ...
          className: clsx(clsx('PageSide-content container', (_props$contentProps = props.contentProps) == null ? void 0 : _props$contentProps.className)),
          children: [props.loading && /*#__PURE__*/jsx(LinearProgress, {}), props.content]
...
function IconButtonGroup(props) {
  var rootProps = pick(props, ['direction', 'spacing']);
  var iconBtnProps = pick(props, ['size', 'color', 'fontSize', 'visible']);
  return /*#__PURE__*/jsx(Stack, _extends({}, rootProps, {
    children: props.items.map(function (i, k) {
      return /*#__PURE__*/jsx(IconButton$1, _extends({}, iconBtnProps, i), k);
    })
  }));
}
...
var BadgeRoot = styled(Box$1)(function (_ref) {
  var theme = _ref.theme,
...
var Badge = /*#__PURE__*/forwardRef(function (inProps, ref) {
  ...
  return /*#__PURE__*/jsx(BadgeRoot, _extends({
    className: clsx(classes == null ? void 0 : classes.root, className)
  }, other, {
    ref: ref,
    children: content
  }));
...
function useEvents(handlers) {
  useEffect(function addEventHandlers() {
    map(handlers, function (handler, type) {
...
function useDebouncedInput(inValue, _temp) {
  ...
  var _useState = useState(inValue),
    value = _useState[0],
...
export { Badge$1 as Badge, Component, ContextMenu, MySvgIcon as FuseSvgIcon, IconButton$1 as IconButton, IconButtonGroup, Layout, PageSide, Toolbar, ToolbarItem, Tooltip$1 as Tooltip, components, emitter$1 as emitter, components$1 as layoutComponents, registerComponent, registerLayout, useDebouncedInput, useEvents };
